...
## 项目介绍
这是一个基于 WebRTC 技术 Mesh 架构实现的多人视频会议应用，使用 WebSocket 作为信令服务器，支持同一局域网内或公网跨局域网的网页端多人（上限四个客户端）实时音视频通信，同时包含会议内文字聊天互动功能。该项目包含完整的前端页面和后端信令服务器，开箱即用，适合学习和扩展 WebRTC 相关技术。
